...
public class EntityMaidPcikLava extends EntityAIMoveToBlock {
    private final AbstractEntityMaid maid;

    public EntityMaidPcikLava(AbstractEntityMaid entityMaid, float speed) {
    ...
    public void updateTask() {
        ...
        if (bucket != ItemStack.EMPTY) {
            ...
            ItemHandlerHelper.insertItemStacked(this.maid.getAvailableInv(false), new ItemStack(Items.LAVA_BUCKET), false);
        }
    }
    ...
    protected boolean shouldMoveTo(World worldIn, BlockPos pos) {
        return worldIn.getBlockState(pos) == Blocks.LAVA.getDefaultState();
    }
}
