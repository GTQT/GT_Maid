...
import keqing.gtmaid.enetity.EntityMaidBrokeTree;
...
public class TaskBrokeTree implements IMaidTask {
    public static final ResourceLocation UID = new ResourceLocation(MOD_ID, "log");
    ...
    public EntityAIBase createAI(AbstractEntityMaid maid) {
        return new EntityMaidBrokeTree(maid, 0.6f);
    }
}
