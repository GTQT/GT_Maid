...
import keqing.gtmaid.enetity.EntityMaidPcikLava;
...
public class TaskPickLava implements IMaidTask {
    public static final ResourceLocation UID = new ResourceLocation(MOD_ID, "picklava");
    ...
    public EntityAIBase createAI(AbstractEntityMaid maid) {
        return new EntityMaidPcikLava(maid, 0.6f);
    }
}
