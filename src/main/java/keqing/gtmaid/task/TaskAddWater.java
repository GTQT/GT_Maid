...
import keqing.gtmaid.enetity.EntityMaidAddWater;
...
public class TaskAddWater implements IMaidTask {
    public static final ResourceLocation UID = new ResourceLocation(MOD_ID, "addwater");
    ...
    public EntityAIBase createAI(AbstractEntityMaid maid) {
        return new EntityMaidAddWater(maid, 0.6f);
    }
}
