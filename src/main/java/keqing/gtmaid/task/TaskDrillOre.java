...
import keqing.gtmaid.enetity.EntityMaidDrillOre;
...
public class TaskDrillOre implements IMaidTask {

    public static final ResourceLocation UID = new ResourceLocation(MOD_ID, "ore");
    ...
    public ItemStack getIcon() {
        return new ItemStack(Blocks.GOLD_ORE, 1, 0);
    }
    ...
    public EntityAIBase createAI(AbstractEntityMaid maid) {
        return new EntityMaidDrillOre(maid, 0.6f);
    }
}
